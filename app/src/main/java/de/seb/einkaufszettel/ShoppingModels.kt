...
fun createDefaultData(now: Long): ShoppingData {
    ...
    return ShoppingData(
        ...
        frequentItems = listOf(
            ...
            FrequentItem("Joghurt", quantity = "6 Becher", category = "Kühlung", useCount = 2),
            FrequentItem("Eier", quantity = "10 Stück", category = "Kühlung", useCount = 2),
            FrequentItem("Tomaten", quantity = "500 g", category = "Obst & Gemüse", useCount = 1),
            FrequentItem("Müsli", quantity = "1 Packung", category = "Vorrat", useCount = 1),
        ),
